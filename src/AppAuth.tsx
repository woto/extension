...
function AppAuth() {
  ...
  const submitData = () => {
    ...
    fetch(`${appUrl}/auth/login`, {
      ...
      return chrome.storage.sync.set({ api_key: data.api_key });
    }).then(() => {
        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Или{' '}
              <a href="https://roatme.ru/auth/register" target="_blank" className="font-medium text-indigo-600 hover:text-indigo-500">
                зарегистрируйтесь
              </a>
            </p>
          </div>
