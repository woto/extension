...
import { CheckCircleIcon, ThumbDownIcon, ThumbUpIcon, XIcon } from '@heroicons/react/solid';
...
function Icon(props: { title: string }) {
  switch (props.title) {
    case 'ThumbUpIcon':
      return <ThumbUpIcon className="w-5 h-5"></ThumbUpIcon>
    case 'ThumbDownIcon':
      return <ThumbDownIcon className="w-5 h-5"></ThumbDownIcon>
  }
...
export default function SentimentInput(props: {
  ...
  setSentiment: React.Dispatch<React.SetStateAction<Sentiment | null | undefined>>
  options: Sentiment[],
