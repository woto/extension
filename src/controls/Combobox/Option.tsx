...
export default function Option(
  ...
  return (
    <li
      ...
      className={`${props.isHighlighted ? 'text-white bg-indigo-600' : 'text-gray-900'} relative flex items-center content-center cursor-default py-2 pl-3 pr-9`}
      tabIndex={-1}
    >
      ...
      <span className="ml-2 text-slate-400 text-xs" onMouseDown={preventDefault}>
        {props.option.count}
      </span>
