import React, {
  Fragment, SetStateAction, Suspense, useCallback, useEffect, useState,
} from 'react';

import { Transition } from '@headlessui/react';
import { RefreshIcon, SearchIcon, SortAscendingIcon } from '@heroicons/react/solid';
...
export const tabs = ['Wikipedia', 'GoogleGraph', 'DuckDuckGo', 'YandexXML', 'GoogleCustomSearch', 'Iframely', 'Scrapper', 'Screenshot', 'Github', 'Ruby', 'Javascript', 'Youtube', 'Telegram', 'YandexMicrodata', 'YandexImages'] as const;
...
function Sidebar(
  ...
  return (
    <Transition.Child
      ...
      leaveTo="c1"
    >
      <div className={`absolute duration-300 inset-0 transition-transform ${currentTab ? 'c3' : 'c2'} rounded overflow-hidden`}>
