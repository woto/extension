...
export default function TitleInput(props: {
  ...
  const setTitle = (title: string) => {
    props.dispatch({ type: EntityActionType.SET_TITLE, payload: { title: title } });
  }
  ...
  return (
    <>
      ...
      {lengthError && <div className="text-red-400 mt-2 text-sm">Должно быть короче 150 символов</div>}
